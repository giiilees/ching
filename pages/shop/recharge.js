...
function Recharge({ menu, setMenu, menu1 }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Menu title="Recharge" user={user} menu={menu} setMenu={setMenu} />
        </div>
        <div
          className={"  p-0  "}
          style={{
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <input
                                className={
                                  "focus:border-[1px] border-blue-400   bg-transparent border-0 "
                                }
                                style={{
                                  outline: "none",
