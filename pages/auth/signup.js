...
function SignUp({}) {
  ...
  const [color, setColor] = useState("#2F374B");
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Un seul compte pour tout utiliser
              </span>
              <span
                style={{
                  width: "70%",
              ...
              >
                Votre compte Chinguitel vous permet d'utiliser tous nos services
                à la fois en utilisant un seul compte.
              </span>
            </div>
            {/* <img
              className={"sm:flex hidden"}
            ...
            >
              ...
              <form className={"flex  flex-col "}>
                <>
                  ...
                  <a
                    onClick={(e) => {
                      if (disabled || password != passwordCon) return;
                      submit(e);
                    }}
                    style={{
                      display: "flex",
                      ...
                      width: "100%",
                      backgroundColor:
                        password != passwordCon ? "grey" : "#000",
                      justifyContent: "center",
                      alignItems: "center",

                      marginBottom: 50,
                      cursor:
                        password != passwordCon ? "not-allowed" : "pointer",
                    }}
                  >
                    {!disabled && (
                      <span
